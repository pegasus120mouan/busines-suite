...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Nouveau poste</h1>
    </div>

    <form action="{{ route('hr.postes.store') }}" method="POST" class="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
        @csrf
        ...
        <div>
            ...
            <input type="number" name="salaire_base" value="{{ old('salaire_base', 0) }}" required min="0" step="1000"
